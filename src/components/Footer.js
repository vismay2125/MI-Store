  ...
  return (
    <>
      ...
      <div className="PreFooter2">
        ...
        <div>
          <a href="https://www.facebook.com/vismay.patel.90834/" target="_blank">{facebookIcon}</a>
          <a href="https://www.instagram.com/er_vismay_2125/" target="_blank">{instagramIcon}</a>
          <a href="https://twitter.com/VismayP16574607" target="_blank"> {twitterIcon}</a>
